        ...
        static void Main(string[] args)
        {
            ...
            switch (broj_operacije)
            {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    if(drugi_broj==0) Console.WriteLine("Ne možemo dijeliti s 0!");
                    else
                    {
                ...
                case 5:
                    break;
                default:
                    Console.WriteLine("Odabir opcije nije uspio, nemam pojma šta je odabrano, no nije ništa od ponuđenog!");
                    break;
            }
        }
    }
